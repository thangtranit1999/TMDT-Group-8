...
class Xoo_Aff_Fields{
	...
	*/
	...
	public function set_defaults(){
		...
		do_action( 'xoo_aff_'.$this->plugin_slug.'_add_predefined_fields' ); //Hook for adding predefined fields
	...
	*/
	...
	public function set_default_field_settings(){
		...
		$field_settings = apply_filters( 'xoo_aff_'.$this->plugin_slug.'_default_field_settings', $field_settings );
